    ...
    <div class="content">
        <div class="container">
            ...
            <div class="form-create">
                <form action="index.php?controller=NoteController&action=store" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title" id="title" placeholder="Tiêu đề ghi chú (tối đa 50 ký tự)..." value="<?php echo $_SESSION['old']['title'] ?? "" ?>">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" name="content" id="content" cols="30" rows="10"><?php echo $_SESSION['old']['content'] ?? "" ?></textarea>
                    </div>
